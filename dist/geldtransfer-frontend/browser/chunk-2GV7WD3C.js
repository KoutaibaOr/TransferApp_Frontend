...
function ExchangeComponent_Conditional_40_For_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(17, ExchangeComponent_Conditional_40_For_24_Conditional_17_Template, 3, 1, "td");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ExchangeComponent_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, ExchangeComponent_Conditional_40_Conditional_4_Template, 2, 1, "button", 18);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275template(21, ExchangeComponent_Conditional_40_Conditional_21_Template, 2, 1, "th");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "tbody");
    \u0275\u0275repeaterCreate(23, ExchangeComponent_Conditional_40_For_24_Template, 18, 12, "tr", null, _forTrack0, false, ExchangeComponent_Conditional_40_ForEmpty_25_Template, 7, 1, "tr");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
...
function ExchangeComponent_Conditional_42_For_25_Template(rf, ctx) {
  if (rf & 1) {
...
function ExchangeComponent_Conditional_42_ForEmpty_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 38)(2, "div", 27)(3, "div", 28);
    \u0275\u0275text(4, "\u{1F4CB}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "h3");
    \u0275\u0275text(6);
...
function ExchangeComponent_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(24, ExchangeComponent_Conditional_42_For_25_Template, 30, 29, "tr", null, _forTrack0, false, ExchangeComponent_Conditional_42_ForEmpty_26_Template, 7, 1, "tr");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function ExchangeComponent_Conditional_43_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 55)(1, "div", 60)(2, "span");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(18, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div", 62)(20, "span", 22);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "span", 63);
    \u0275\u0275text(23);
    \u0275\u0275pipe(24, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 60)(26, "span");
    \u0275\u0275text(27);
    \u0275\u0275elementEnd();
...
function ExchangeComponent_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 48)(13, "input", 49);
    ...
    \u0275\u0275repeaterCreate(15, ExchangeComponent_Conditional_43_For_16_Template, 2, 2, "option", 51, _forTrack0);
    ...
    \u0275\u0275text(20, "\u21C5");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 46)(22, "label", 47);
    \u0275\u0275text(23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 48);
    \u0275\u0275element(25, "input", 54);
    \u0275\u0275pipe(26, "number");
    \u0275\u0275elementStart(27, "select", 50);
    ...
    \u0275\u0275repeaterCreate(28, ExchangeComponent_Conditional_43_For_29_Template, 2, 2, "option", 51, _forTrack0);
    \u0275\u0275elementStart(30, "option", 52);
    \u0275\u0275text(31, "EUR");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275template(32, ExchangeComponent_Conditional_43_Conditional_32_Template, 31, 28, "div", 55);
    \u0275\u0275elementStart(33, "div", 46)(34, "label", 47);
    \u0275\u0275text(35);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("value", \u0275\u0275pipeBind2(26, 13, (tmp_7_0 = ctx_r1.preview()) == null ? null : tmp_7_0.customerPayout, "1.2-2"));
    \u0275\u0275advance(2);
...
function ExchangeComponent_Conditional_44_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6, "\u2715");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 44)(8, "div", 66)(9, "div", 46)(10, "label", 47);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "input", 67);
...
var ExchangeComponent = class _ExchangeComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExchangeComponent, selectors: [["app-exchange"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 45, vars: 24, consts: [[1, "page-header"], [1, "page-title"], [1, "page-subtitle"], [1, "btn", "btn-primary", 3, "click"], [1, "kpi-grid", 2, "margin-bottom", "1.5rem"], [1, "kpi-card"], [1, "kpi-icon", "purple"], [1, "kpi-label"], [1, "kpi-value"], [1, "kpi-icon", "green"], [1, "kpi-icon", "blue"], [1, "tabs"], [1, "tab-btn", 3, "click"], [1, "card", 2, "padding", "0"], [1, "balances-grid"], [1, "modal-backdrop"], [1, "card-header", 2, "padding", "1.25rem 1.5rem"], [1, "card-title"], [1, "btn", "btn-ghost", "btn-sm"], [1, "table-wrap"], [1, "btn", "btn-ghost", "btn-sm", 3, "click"], [1, "currency-badge"], [1, "fw-600"], [1, "text-muted"], [1, "badge"], [1, "btn", "btn-danger", "btn-sm", 3, "click"], ["colspan", "7"], [1, "empty-state"], [1, "empty-icon"], [1, "card", "branch-balance-card"], [1, "card-header"], [1, "balance-list"], [1, "balance-row"], [1, "balance-amount"], [1, "ref"], [1, "currency-badge", "sm"], [1, "text-ok", "fw-600"], [1, "text-muted", 2, "font-size", ".8rem"], ["colspan", "8"], [1, "modal-backdrop", 3, "click"], [1, "modal", "modal-lg", 3, "click"], [1, "modal-header"], [1, "modal-title"], [1, "btn", "btn-icon", 3, "click"], [1, "modal-body"], [1, "exchange-form"], [1, "form-group"], [1, "form-label"], [1, "amount-row"], ["type", "number", "placeholder", "0.00", 1, "form-control", 3, "ngModelChange", "input", "ngModel"], [1, "form-control", "currency-sel", 3, "ngModelChange", "change", "ngModel"], [3, "value"], ["value", "EUR"], [1, "exchange-arrow"], ["readonly", "", 1, "form-control", 3, "value"], [1, "preview-box"], [1, "form-control", 3, "ngModelChange", "ngModel"], [1, "modal-footer"], [1, "btn", "btn-ghost", 3, "click"], [1, "btn", "btn-primary", 3, "click", "disabled"], [1, "preview-row"], [1, "text-warn"], [1, "preview-row", "highlight"], [1, "fw-600", "text-ok"], [1, "text-accent", "fw-600"], [1, "modal", 3, "click"], [1, "form-grid"], ["placeholder", "EUR", 1, "form-control", 3, "ngModelChange", "ngModel"], ["placeholder", "MAD", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "number", "step", "0.0001", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "number", "step", "0.1", 1, "form-control", 3, "ngModelChange", "ngModel"]], template: function ExchangeComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(39);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(40, ExchangeComponent_Conditional_40_Template, 26, 10, "div", 13)(41, ExchangeComponent_Conditional_41_Template, 3, 0, "div", 14)(42, ExchangeComponent_Conditional_42_Template, 27, 9, "div", 13)(43, ExchangeComponent_Conditional_43_Template, 42, 16, "div", 15)(44, ExchangeComponent_Conditional_44_Template, 30, 11, "div", 15);
      }
      if (rf & 2) {
        let tmp_4_0;
        let tmp_6_0;
        ...
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate((tmp_4_0 = (tmp_4_0 = ctx.stats()) == null ? null : tmp_4_0.todayTransactions) !== null && tmp_4_0 !== void 0 ? tmp_4_0 : "\u2014");
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate(ctx.t().todayProfit);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1("\u20AC ", ctx.fmt((tmp_6_0 = ctx.stats()) == null ? null : tmp_6_0.todayProfit), "");
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate(ctx.t().totalVolume);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1("\u20AC ", ctx.fmt((tmp_8_0 = ctx.stats()) == null ? null : tmp_8_0.totalVolume), "");
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExchangeComponent, { className: "ExchangeComponent", filePath: "src\\app\\features\\exchange\\exchange.component.ts", lineNumber: 262 });
})();
export {
  ExchangeComponent
};
//# sourceMappingURL=chunk-2GV7WD3C.js.map
