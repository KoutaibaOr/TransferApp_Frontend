...
var CashService = class _CashService {
  ...
  getMultiBalances(branch) {
    let params = new HttpParams();
    if (branch)
      params = params.set("branch", branch);
    return this.http.get(`${BASE}/cash/balances`, { params });
  }
  deposit(dto) {
  ...
  bankDeposit(dto) {
    return this.http.post(`${BASE}/bank-deposits`, dto);
  }
  getDayCloses(branch) {
    let params = new HttpParams();
    if (branch)
      params = params.set("branch", branch);
    return this.http.get(`${BASE}/day-closes`, { params });
  }
  dayClose(dto) {
    return this.http.post(`${BASE}/day-closes`, dto);
  }
  getProfits() {
    return this.http.get(`${BASE}/cash/profits`);
  }
  static {
...
//# sourceMappingURL=chunk-3YIH5T6Q.js.map
