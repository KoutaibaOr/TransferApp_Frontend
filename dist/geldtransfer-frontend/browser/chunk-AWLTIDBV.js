...
function AuditComponent_For_27_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(a_r1.entity);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(a_r1.entityId);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(a_r1.ipAddress);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(15, 6, a_r1.createdAt, "dd.MM.yy HH:mm"));
  }
}
...
var AuditComponent = class _AuditComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuditComponent, selectors: [["app-audit"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 29, vars: 4, consts: [[1, "page-header"], [1, "page-title"], [1, "page-subtitle"], [1, "filters-bar"], ["type", "search", "placeholder", "Suchen...", 1, "form-control", 3, "ngModelChange", "input", "ngModel"], [1, "card", 2, "padding", "0"], [1, "table-wrap"], [1, "fw-600"], [1, "badge", "badge-created"], [1, "text-muted"], [2, "font-size", ".75rem", "color", "var(--accent)"], ["colspan", "6"], [1, "empty-state"], [1, "empty-icon"]], template: function AuditComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(26, AuditComponent_For_27_Template, 16, 9, "tr", null, _forTrack0, false, AuditComponent_ForEmpty_28_Template, 7, 0, "tr");
        \u0275\u0275elementEnd()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
        ...
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1("", ctx.total(), " Eintr\xE4ge gesamt");
        \u0275\u0275advance(2);
...
//# sourceMappingURL=chunk-AWLTIDBV.js.map
