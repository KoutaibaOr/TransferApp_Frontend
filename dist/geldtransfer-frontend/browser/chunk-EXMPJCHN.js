...
var LoginComponent = class _LoginComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 26, vars: 11, consts: [[1, "login-page"], [1, "login-card"], [1, "login-logo"], [1, "accent"], [1, "login-sub"], [1, "login-form"], [1, "form-group"], [1, "form-label"], ["type", "email", "placeholder", "admin@firma.de", 1, "form-control", 3, "ngModelChange", "keyup.enter", "ngModel"], ["type", "password", "placeholder", "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", 1, "form-control", 3, "ngModelChange", "keyup.enter", "ngModel"], [1, "login-error"], [1, "btn", "btn-primary", "w-full", 3, "click", "disabled"], [1, "lang-row"], [3, "click"]], template: function LoginComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "src\\app\\features\\auth\\login.component.ts", lineNumber: 53 });
})();
export {
  LoginComponent
};
//# sourceMappingURL=chunk-EXMPJCHN.js.map
