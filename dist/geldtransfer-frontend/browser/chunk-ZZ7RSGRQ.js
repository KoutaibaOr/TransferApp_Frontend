...
function SettingsComponent_Conditional_13_For_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275classMap(u_r6.role === "admin" ? "badge-in_progress" : u_r6.role === "branch_manager" ? "badge-completed" : u_r6.role === "accountant" ? "badge-paid_out" : "badge-created");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(u_r6.role === "admin" ? ctx_r2.t().roleAdmin : u_r6.role === "branch_manager" ? ctx_r2.t().roleBranchManager : u_r6.role === "accountant" ? ctx_r2.t().roleAccountant : ctx_r2.t().roleEmployee);
    \u0275\u0275advance();
...
function SettingsComponent_Conditional_16_For_37_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 42);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SettingsComponent_Conditional_16_For_37_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 44)(1, "select", 49);
    \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Conditional_16_For_37_Template_select_ngModelChange_1_listener($event) {
      const bal_r14 = \u0275\u0275restoreView(_r13).$implicit;
      \u0275\u0275twoWayBindingSet(bal_r14.currency, $event) || (bal_r14.currency = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275repeaterCreate(2, SettingsComponent_Conditional_16_For_37_For_3_Template, 2, 2, "option", 42, _forTrack2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "input", 50);
    \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Conditional_16_For_37_Template_input_ngModelChange_4_listener($event) {
      const bal_r14 = \u0275\u0275restoreView(_r13).$implicit;
      \u0275\u0275twoWayBindingSet(bal_r14.amount, $event) || (bal_r14.amount = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 13);
    \u0275\u0275listener("click", function SettingsComponent_Conditional_16_For_37_Template_button_click_5_listener() {
      const i_r16 = \u0275\u0275restoreView(_r13).$index;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.removeBranchBalance(i_r16));
    });
    \u0275\u0275text(6, "\u2715");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const bal_r14 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", bal_r14.currency);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.currencies());
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", bal_r14.amount);
  }
}
function SettingsComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "div", 40)(34, "label", 43);
    \u0275\u0275text(35);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(36, SettingsComponent_Conditional_16_For_37_Template, 7, 2, "div", 44, _forTrack1);
    \u0275\u0275elementStart(38, "button", 45);
    \u0275\u0275listener("click", function SettingsComponent_Conditional_16_Template_button_click_38_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.addBranchBalance());
    });
    \u0275\u0275text(39);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(40, "div", 46)(41, "button", 47);
    \u0275\u0275listener("click", function SettingsComponent_Conditional_16_Template_button_click_41_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showNewBranch.set(false));
    });
    ...
    \u0275\u0275listener("click", function SettingsComponent_Conditional_16_Template_button_click_43_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r2.t().cashPerCurrency);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.newBranchBalances);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("\uFF0B ", ctx_r2.t().addCurrency, "");
    \u0275\u0275advance(3);
...
function SettingsComponent_Conditional_17_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r18 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 57)(1, "label", 59)(2, "input", 60);
    \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Conditional_17_Conditional_32_Template_input_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r18);
      const ctx_r2 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r2.newUser.canBook, $event) || (ctx_r2.newUser.canBook = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.newUser.canBook);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.t().canBook);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.t().canBookHint);
  }
}
function SettingsComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "option", 55);
    \u0275\u0275text(29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "option", 56);
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(32, SettingsComponent_Conditional_17_Conditional_32_Template, 7, 3, "div", 57);
    \u0275\u0275elementStart(33, "div", 37)(34, "label", 38);
    \u0275\u0275text(35);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "input", 58);
    \u0275\u0275twoWayListener("ngModelChange", function SettingsComponent_Conditional_17_Template_input_ngModelChange_36_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(37, "div", 46)(38, "button", 47);
    \u0275\u0275listener("click", function SettingsComponent_Conditional_17_Template_button_click_38_listener() {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.showNewUser.set(false));
    });
    \u0275\u0275text(39);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "button", 48);
    \u0275\u0275listener("click", function SettingsComponent_Conditional_17_Template_button_click_40_listener() {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.t().roleAccountant);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.t().roleAdmin);
    \u0275\u0275advance();
    \u0275\u0275conditional(32, ctx_r2.newUser.role === "accountant" ? 32 : -1);
    \u0275\u0275advance(3);
...
var SettingsComponent = class _SettingsComponent {
  constructor(svc, branchSvc, toast, i18n, auth) {
    ...
    this.newUser = { name: "", email: "", password: "", role: "employee", branch: "", canBook: false };
  ...
  addBranchBalance() {
    ...
    if (next)
      this.newBranchBalances.push({ currency: next.code, amount: 0 });
  }
  removeBranchBalance(i) {
  ...
  createBranch() {
    ...
    const dto = __spreadProps(__spreadValues({}, this.newBranchDto), { balances: this.newBranchBalances.filter((b) => b.amount > 0), cashBalance: this.newBranchBalances.find((b) => b.currency === "EUR")?.amount ?? 0 });
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SettingsComponent, selectors: [["app-settings"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 18, vars: 19, consts: [[1, "page-header"], [1, "page-title"], [1, "tabs"], [1, "tab-btn", 3, "click"], [1, "card", 2, "padding", "0"], [1, "card"], [1, "modal-backdrop"], [1, "card-header", 2, "padding", "1.25rem 1.5rem"], [1, "card-title"], [1, "table-wrap"], [1, "fw-600"], [1, "badge", "badge-created"], [1, "badge"], [1, "btn", "btn-danger", "btn-sm", 3, "click"], [1, "card-header"], [1, "btn", "btn-primary", "btn-sm", 3, "click"], [1, "user-row"], [1, "u-avatar"], [2, "flex", "1"], [1, "fw-600", 2, "font-size", ".875rem"], [2, "font-size", ".75rem", "color", "var(--muted)"], [1, "btn", "btn-danger", "btn-sm", 3, "click", "title"], [1, "empty-state"], [1, "branch-card"], [1, "empty-icon"], [1, "branch-dot"], [1, "fw-600", 2, "font-size", ".9rem"], [2, "text-align", "right", "min-width", "110px"], [1, "fw-600", 2, "font-size", ".85rem", "color", "var(--accent2)"], [2, "font-size", ".72rem", "color", "var(--muted)"], [1, "modal-backdrop", 3, "click"], [1, "modal", 3, "click"], [1, "modal-header"], [1, "modal-title"], [1, "btn", "btn-icon", 3, "click"], [1, "modal-body"], [1, "form-grid"], [1, "form-group"], [1, "form-label"], [1, "form-control", 3, "ngModelChange", "ngModel"], [1, "form-group", 2, "margin-top", ".75rem"], ["value", ""], [3, "value"], [1, "form-label", 2, "margin-bottom", ".5rem"], [2, "display", "flex", "gap", ".5rem", "margin-bottom", ".4rem", "align-items", "center"], [1, "btn", "btn-ghost", "btn-sm", 2, "margin-top", ".25rem", 3, "click"], [1, "modal-footer"], [1, "btn", "btn-ghost", 3, "click"], [1, "btn", "btn-primary", 3, "click"], [1, "form-control", 2, "width", "100px", 3, "ngModelChange", "ngModel"], ["type", "number", "min", "0", "step", "0.01", "placeholder", "0.00", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "email", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "password", 1, "form-control", 3, "ngModelChange", "ngModel"], ["value", "employee"], ["value", "branch_manager"], ["value", "accountant"], ["value", "admin"], [1, "form-group", 2, "background", "var(--bg)", "padding", ".75rem", "border-radius", "var(--radius-sm)", "border", "1px solid var(--border)"], ["placeholder", "Berlin-Mitte", 1, "form-control", 3, "ngModelChange", "ngModel"], [2, "display", "flex", "align-items", "center", "gap", ".5rem", "cursor", "pointer", "font-size", ".875rem"], ["type", "checkbox", 2, "width", "16px", "height", "16px", 3, "ngModelChange", "ngModel"], [2, "font-size", ".75rem", "color", "var(--muted)", "margin", ".25rem 0 0 1.5rem"]], template: function SettingsComponent_Template(rf, ctx) {
      if (rf & 1) {
    ...
    }, dependencies: [CommonModule, DecimalPipe, FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, NumberValueAccessor, CheckboxControlValueAccessor, SelectControlValueAccessor, NgControlStatus, MinValidator, NgModel], styles: ["\n\n.settings-grid[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 1.5rem;\n  margin-top: 1.5rem;\n}\n.user-row[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: .75rem;\n  padding: .65rem;\n  background: var(--bg);\n  border-radius: var(--radius-sm);\n  margin-bottom: .4rem;\n}\n.u-avatar[_ngcontent-%COMP%] {\n  width: 34px;\n  height: 34px;\n  border-radius: 50%;\n  background: var(--accent);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: .75rem;\n  font-weight: 700;\n  color: #fff;\n  flex-shrink: 0;\n}\n.branch-card[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: .75rem;\n  padding: .75rem 1rem;\n  background: var(--bg);\n  border-radius: var(--radius-sm);\n  margin-bottom: .5rem;\n  border: 1px solid var(--border);\n}\n.branch-dot[_ngcontent-%COMP%] {\n  width: 12px;\n  height: 12px;\n  border-radius: 50%;\n  flex-shrink: 0;\n}\n@media (max-width:900px) {\n  .settings-grid[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr;\n  }\n}\n/*# sourceMappingURL=settings.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SettingsComponent, { className: "SettingsComponent", filePath: "src\\app\\features\\settings\\settings.component.ts", lineNumber: 206 });
})();
export {
  SettingsComponent
};
//# sourceMappingURL=chunk-ZZ7RSGRQ.js.map
