...
var authInterceptor = (req, next) => {
  ...
  return next(authReq).pipe(catchError((err) => {
    if (err.status === 401) {
      ...
      toast.error("Keine Berechtigung f\xFCr diese Aktion");
    } else if (err.status >= 500) {
      toast.error("Serverfehler \u2014 bitte sp\xE4ter erneut versuchen");
    }
...
function ToastComponent_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ToastComponent_For_2_Template_div_click_0_listener() {
      ...
      return \u0275\u0275resetView(ctx_r2.toast.remove(t_r2.id));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(t_r2.type === "success" ? "\u2705" : t_r2.type === "error" ? "\u274C" : "\u2139\uFE0F");
    \u0275\u0275advance(2);
...
var ToastComponent = class _ToastComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastComponent, selectors: [["app-toast"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 0, consts: [[1, "toast-container"], [1, "toast", 3, "class"], [1, "toast", 3, "click"], [1, "toast-icon"], [1, "toast-msg"]], template: function ToastComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ToastComponent, { className: "ToastComponent", filePath: "src\\app\\shared\\components\\toast\\toast.component.ts", lineNumber: 21 });
})();
...
var AppComponent = class _AppComponent {
  ...
  static {
    this.\u0275fac = function AppComponent_Factory(t) {
      return new (t || _AppComponent)(\u0275\u0275directiveInject(I18nService));
    };
  }
  static {
