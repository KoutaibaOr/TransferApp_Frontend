...
const EN = {
  ...
  bookkeeping: 'Bookkeeping', bookkeepingSubtitle: 'All transfers, profits & day close overview',
  settled: 'Settled',
  duplicates: 'Duplicates', possibleDuplicate: 'Possible duplicate',
  possibleDuplicates: 'Possible Duplicates', noDuplicates: 'No duplicates found',
  duplicatesHint: 'Same sender, receiver, amount and date',
  needsReview: 'need review', totalAmount: 'Total amount',
  exportProfits: 'Export Profits',
  dayCloseHint: 'Shows expected cash per branch. Staff count physical cash at end of day.',
  // Nav section headers
...
const AR: typeof EN = {
  ...
  bookkeeping: 'المحاسبة', bookkeepingSubtitle: 'جميع التحويلات والأرباح وإغلاق اليوم',
  settled: 'المسلمة',
  duplicates: 'المكررة', possibleDuplicate: 'تحويل مكرر محتمل',
  possibleDuplicates: 'تحويلات مكررة محتملة', noDuplicates: 'لا توجد تحويلات مكررة',
  duplicatesHint: 'نفس المرسل والمستلم والمبلغ والتاريخ',
  needsReview: 'تحتاج مراجعة', totalAmount: 'المجموع',
  exportProfits: 'تصدير الأرباح',
  dayCloseHint: 'يعرض هذا الرصيد المتوقع لكل فرع. يقوم الموظفون بعد الرصيد الفعلي في نهاية اليوم.',
  // Nav section headers
