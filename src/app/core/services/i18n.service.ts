...
const EN = {
  ...
  totalTransfers: 'Transfers total', allStatuses: 'All Statuses', allBranches: 'All Branches',
  branch: 'Branch', actions: 'Actions', details: 'Details', close: 'Close',
  newTransfer: 'New Transfer', createTransfer: 'Create Transfer',
...
const AR: typeof EN = {
  ...
  totalTransfers: 'إجمالي التحويلات', allStatuses: 'جميع الحالات', allBranches: 'جميع الفروع',
  branch: 'الفرع', actions: 'الإجراءات', details: 'التفاصيل', close: 'إغلاق',
  newTransfer: 'تحويل جديد', createTransfer: 'إنشاء تحويل',
